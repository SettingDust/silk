...
@JvmName("setByteList")
operator fun CompoundTag.set(key: String, value: List<Byte>) = putByteArray(key, value)
...
@JvmName("setIntList")
operator fun CompoundTag.set(key: String, value: List<Int>) = putIntArray(key, value)
